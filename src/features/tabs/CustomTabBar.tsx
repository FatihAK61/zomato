        ...
        <>
            <Animated.View
                style={[
                    ...
                    animatedStyle,
                    { paddingBottom: bottom.bottom, backgroundColor: isLiveTabFocused ? Colors.dark : Colors.background }
                ]}>
                ...
                <View style={styles.tabContainer}>
                    {state?.routes?.map((route, index) => {
                        ...
                        return (
                            <ScalePress onPress={onPress} onLongPress={onLongPress} key={index} style={[styles.tabItem, isFocused ? styles.focusedTabItem : {}]}>
                ...
                <TouchableOpacity
                    ...
                    activeOpacity={0.9}
                    onPress={() => { Linking.openURL('https://google.com.tr') }}>
                    <Image
