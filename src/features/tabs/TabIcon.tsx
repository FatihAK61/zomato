...
interface IconProp { focused: boolean; }
const styles = { width: RFValue(18), height: RFValue(18) };
const tabStyles: ViewStyle = { justifyContent: 'center', alignItems: 'center' };
