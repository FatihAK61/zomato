    ...
    return (
        <View style={styles.container}>
            <View style={styles.infoContainer}>
                <Image source={item?.isVeg ? require('@assets/icons/veg.png') : require('@assets/icons/non_veg.png')}
                    style={styles.vegIcon}
                />
                <CustomText fontSize={12} numberOfLines={1} fontFamily='Okra-Medium'>
                    {item?.name}
                </CustomText>
                <CustomText fontSize={10} numberOfLines={2} style={styles.lowOpacity} fontFamily='Okra-Medium'>
                    {item?.description}
                </CustomText>
